...
public class JmxServletV3 extends HttpServlet implements ServletContextListener {
    ...
    Logger logger = LoggerFactory.getLogger(JmxServletV3.class);
    /**
     * 
     */
    ...
    static public class LocalJMXPort {
        ...
        public jmxHandle start() {
            ...
            try {
                ...
                csfb.setServiceUrl("service:jmx:rmi://" + BINDING_ADDRESS
                            + ":"
                            + port
                            + "/jndi/rmi://"
                            + BINDING_ADDRESS
                ...
                csfb.setServer(mbs);
                rmiServer = (JMXConnectorServer) csfb.getObject();
                rmiServer.start();
